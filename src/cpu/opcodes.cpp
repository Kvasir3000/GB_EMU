...
{
	instruction_table_map[LD_A_n] =    { "LD_A_n",   8,  &A,      nullptr, nullptr, nullptr, &CPU::ld_r_n };
	instruction_table_map[LD_B_n] =    { "LD_B_n",   8,  &B,      nullptr, nullptr, nullptr, &CPU::ld_r_n };
	instruction_table_map[LD_C_n] =    { "LD_C_n",   8,  &C,      nullptr, nullptr, nullptr, &CPU::ld_r_n };
	instruction_table_map[LD_D_n] =    { "LD_D_n",   8,  &D,      nullptr, nullptr, nullptr, &CPU::ld_r_n };
	instruction_table_map[LD_E_n] =    { "LD_E_n",   8,  &E,      nullptr, nullptr, nullptr, &CPU::ld_r_n };
	instruction_table_map[LD_H_n] =    { "LD_H_n",   8,  &H,      nullptr, nullptr, nullptr, &CPU::ld_r_n };
	instruction_table_map[LD_L_n] =    { "LD_L_n",   8,  &L,      nullptr, nullptr, nullptr, &CPU::ld_r_n };
	...
	instruction_table_map[LD_A_nn] =   { "LD_A_nn",  16, &A,      nullptr, nullptr, nullptr, &CPU::ld_r_nn };
	...
	instruction_table_map[LD_HL_n] =   { "LD_HL_n",  12, &H,      &H,      &L,      nullptr, &CPU::ld_r1r3_n };
	...
	instruction_table_map[LD_nn_A] =   { "LD_nn_A",  16, &A,      nullptr, nullptr, nullptr, &CPU::ld_nn_r };
...
// Loads data from memory address stored at next 2-bytes of memory to r register
void CPU::ld_r_nn()
{
...
// Loads data from r2 to r1 register
void CPU::ld_r1_r2()
{
...
// Loads data from memory address stored in 16-bit r2r4 register to r1 register
void CPU::ld_r1_r2r4()
{
...
// Loads data from memory address stored in 16-bit r2r4 register to r1 register and decrements r2r4
...
// Loads data from r register to memory address stored at 16-bit r1r3 register
void CPU::ld_r1r3_r2()
{
...
// Loads data from next byte to memory address stored at 16-bit r1r3 register
void CPU::ld_r1r3_n()
{
	uint16_t memory_addr = (current_instruction.parameter_one->register_value << 8) | 
		                    current_instruction.parameter_three->register_value;
...
void CPU::dec_r1r3()
{
	uint16_t register_data = (current_instruction.parameter_one->register_value << 8) |
		                      current_instruction.parameter_three->register_value;
	register_data--;
